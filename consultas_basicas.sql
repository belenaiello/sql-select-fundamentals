...
-- Se utiliza SELECT * para explorar rápidamente una tabla durante el análisis inicial.
-- En un entorno de producción no es recomendable porque devuelve columnas innecesarias, puede afectar el rendimiento y dificulta el mantenimiento del código.
